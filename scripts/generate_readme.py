...
GITHUB_TOKEN = os.environ.get('DSH_STATS_PAT') or os.environ.get('GH_PAT') or os.environ.get('GITHUB_TOKEN')
...
if pattern.search(content):
    ...
    with open(readme_path, 'w') as f:
        f.write(content)
    print("Successfully updated DSH Org profile README.md with latest metrics.")
else:
